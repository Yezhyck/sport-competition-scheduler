    ...
    public Collection<Game> findAll() {
        ...
        jdbcTemplate.query("SELECT G.ID AS G_ID, G.DATE_TIME_BEGIN AS G_DATE_TIME_BEGIN, " +
                ...
                (rs, rowNum) -> {
                    ...
                    if (!gameResultMap.containsKey(gameResultId)) {
        ...
        gameResultMap.forEach((key, value) -> gameMap.get(value.getGameId()).getGameResultList().add(value));
